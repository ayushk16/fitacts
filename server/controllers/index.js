...
export default { getUsers, creatUserController, loginController, getAllEvents, getAllActivities, getActivity, updateFavorite, updateEvent, getUserFavorites, getTopEvents, getUser, updateUser, following, follow, unfollow, createEvent };